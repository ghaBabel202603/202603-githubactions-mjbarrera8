...
2. Crear un archivo llamado 17-1-custom-actions-composite.yaml en la carpeta .github/workflows en la raíz de tu repositorio.
...
5. Modificar el flujo 17-1-custom-actions.yaml para pasar el input target-env como parámetro a la acción personalizada.
